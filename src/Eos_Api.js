...
function decode(d) {
  return /* record */[
          ...
          /* virtualBlockCpuLimit */Json_decode.field("virtual_block_cpu_limit", BigNumber.decodeAny, d),
          /* virtualBlockNetLimit */Json_decode.field("virtual_block_net_limit", BigNumber.decodeAny, d),
          /* blockCpuLimit */Json_decode.field("block_cpu_limit", BigNumber.decodeAny, d),
          /* blockNetLimit */Json_decode.field("block_net_limit", BigNumber.decodeAny, d)
        ];
}
